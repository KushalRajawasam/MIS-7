...
def Download_Video():
    ...
    video.download('C:/Users/kusha/OneDrive/ClassApps/YouTube Video Downloader')
    #video.download('C:/Users/shwad/Documents/youtube')
...
link_enter = tk.Entry(root, width=53, textvariable=yourlink, font='arial 15 bold',
...
tk.Button(root, text='DOWNLOAD VIDEO', font='arial 15 bold', fg="white", bg='black',
          padx=2,
